                ...
                <div className='landing-grid'>
                    <Cell col={12}>
                        <div className='banner-text'>
                            ...
                            <div className='social-links'>
                                ...
                                {/* GitHub Logo */}
                                <a href='https://github.com/jamesRoss06000' rel='noopener noreferrer' target='_blank'>
                    ...
                    <div className='gridDirection' style={{ textAlign: 'center' }}>
                        ...
                        <div className='cvContainer'>
                            <div className='cvDiv'>
                                <a href="https://1drv.ms/b/s!AkHwqNuAoM_PjqVep1KyLAzXw-n3NA" rel='noopener noreferrer'
                                ...
                                <a href="https://1drv.ms/b/s!AkHwqNuAoM_PjqVdDf_CDu3V4itKZA" rel='noopener noreferrer'
